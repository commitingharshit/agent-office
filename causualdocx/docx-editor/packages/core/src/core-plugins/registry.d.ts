 ...
 */
import type { CorePlugin, CommandHandler, McpToolDefinition, PluginEventListener, PluginRegistrationResult, PluginOptions } from './types';
/**
 ...
 */
export declare function registerPlugins(plugins: CorePlugin[], options?: PluginOptions): PluginRegistrationResult[];
/**
 ...
 */
export declare function createPluginRegistrar(options: PluginOptions): (plugin: CorePlugin) => PluginRegistrationResult;
