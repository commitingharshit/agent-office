 ...
 */
export declare function isZodSchema(schema: unknown): schema is ZodSchemaLike;
/**
...
export type { CorePlugin as Plugin, CommandHandler as PluginCommandHandler, McpToolDefinition as ToolDefinition, McpToolHandler as ToolHandler, McpToolResult as ToolResult, };
