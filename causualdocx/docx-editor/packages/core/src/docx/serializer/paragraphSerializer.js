...
function serializeBorder(border, elementName) {
    ...
    const attrs = [`w:val="${border.style}"`];
 ...
 */
export function serializeParagraphFormatting(formatting, propertyChanges) {
    var _a, _b, _c, _d, _e;
    const parts = [];
    if (formatting) {
        ...
        else if ((_a = formatting.presentEmpty) === null || _a === void 0 ? void 0 : _a.pBdr) {
            parts.push('<w:pBdr/>');
        }
        // Shading
        ...
        if (formatting.adjustRightInd !== undefined) {
            parts.push(formatting.adjustRightInd ? '<w:adjustRightInd/>' : '<w:adjustRightInd w:val="0"/>');
        }
        ...
        else if ((_b = formatting.presentEmpty) === null || _b === void 0 ? void 0 : _b.spacing) {
        ...
        else if ((_c = formatting.presentEmpty) === null || _c === void 0 ? void 0 : _c.ind) {
            parts.push('<w:ind/>');
        }
        // Text direction (bidi)
        if (formatting.bidi) {
        ...
        if (formatting.runProperties) {
            ...
            else if ((_d = formatting.presentEmpty) === null || _d === void 0 ? void 0 : _d.rPr) {
                parts.push('<w:rPr/>');
            }
        }
        else if ((_e = formatting.presentEmpty) === null || _e === void 0 ? void 0 : _e.rPr) {
            parts.push('<w:rPr/>');
        }
    }
...
function serializeSimpleField(field) {
    ...
    const rPrXml = (firstRun === null || firstRun === void 0 ? void 0 : firstRun.formatting) ? serializeTextFormatting(firstRun.formatting) : '';
...
function serializeComplexField(field) {
    ...
    const resultFormatting = (_b = (_a = field.fieldResult) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.formatting;
...
function serializeInlineSdt(sdt) {
    ...
    if (props.sdtId !== undefined)
        prParts.push(`<w:id w:val="${props.sdtId}"/>`);
    ...
    switch (props.sdtType) {
        ...
        case 'date':
            ...
            break;
        case 'dropdown': {
            const items = ((_a = props.listItems) !== null && _a !== void 0 ? _a : [])
                .map((i) => `<w:listItem w:displayText="${escapeXml(i.displayText)}" w:value="${escapeXml(i.value)}"/>`)
                .join('');
            prParts.push(`<w:dropDownList>${items}</w:dropDownList>`);
            break;
        }
        case 'comboBox': {
            const items = ((_b = props.listItems) !== null && _b !== void 0 ? _b : [])
                .map((i) => `<w:listItem w:displayText="${escapeXml(i.displayText)}" w:value="${escapeXml(i.value)}"/>`)
                .join('');
        ...
        case 'checkbox': {
            const checkboxParts = [`<w14:checked w14:val="${props.checked ? '1' : '0'}"/>`];
            if (props.checkedState) {
                checkboxParts.push(`<w14:checkedState w14:val="${escapeXml(props.checkedState.val)}" w14:font="${escapeXml(props.checkedState.font)}"/>`);
            }
            if (props.uncheckedState) {
                checkboxParts.push(`<w14:uncheckedState w14:val="${escapeXml(props.uncheckedState.val)}" w14:font="${escapeXml(props.uncheckedState.font)}"/>`);
            }
...
function serializeParagraphContent(content) {
    switch (content.type) {
        ...
        case 'moveFromRangeStart':
            return serializeMoveRangeStart('moveFromRangeStart', content);
        case 'moveFromRangeEnd':
            return `<w:moveFromRangeEnd w:id="${content.id}"/>`;
        case 'moveToRangeStart':
            return serializeMoveRangeStart('moveToRangeStart', content);
        case 'moveToRangeEnd':
 ...
 */
export function hasParagraphContent(paragraph) {
    return paragraph.content.length > 0;
}
/**
 * Check if a paragraph has formatting
 */
export function hasParagraphFormatting(paragraph) {
 ...
 */
export function getParagraphPlainText(paragraph) {
    const texts = [];
    for (const content of paragraph.content) {
        if (content.type === 'run') {
 ...
 */
export function createEmptyParagraph(formatting) {
    return {
        type: 'paragraph',
        formatting,
        content: [],
 ...
 */
export function createTextParagraph(text, paragraphFormatting, textFormatting) {
    return {
        type: 'paragraph',
 ...
 */
export function isListParagraph(paragraph) {
    var _a;
...
export function getListLevel(paragraph) {
    var _a, _b, _c;
    return (_c = (_b = (_a = paragraph.formatting) === null || _a === void 0 ? void 0 : _a.numPr) === null || _b === void 0 ? void 0 : _b.ilvl) !== null && _c !== void 0 ? _c : -1;
}
export default serializeParagraph;
//# sourceMappingURL=paragraphSerializer.js.map