 ...
 */
import { findChild, findChildren, getAttribute, parseNumericAttribute, parseBooleanElement, } from './xmlParser';
 ...
 */
function parseColorValue(colorStr, themeColor, themeTint, themeShade) {
 ...
 */
function parseOrientation(orient) {
    switch (orient) {
        case 'landscape':
            return 'landscape';
        case 'portrait':
 ...
 */
function parseSectionStart(type) {
    switch (type) {
        case 'continuous':
            return 'continuous';
        case 'nextPage':
 ...
 */
function parseVerticalAlign(align) {
    switch (align) {
        case 'top':
            return 'top';
        case 'center':
 ...
 */
function parseLineNumberRestart(restart) {
    switch (restart) {
        case 'continuous':
            return 'continuous';
        case 'newPage':
 ...
 */
export function parseSectionProperties(sectPr, _rels) {
    const props = {};
    if (!sectPr)
        return props;
    // ============================================================================
    ...
    if (pgNumType) {
        ...
        if (chapStyle !== undefined)
            pnt.chapStyle = chapStyle;
    ...
    if (background) {
        ...
        if (themeColor) {
            props.background.themeColor = themeColor;
        }
 ...
 */
export function getPageWidthPixels(props, defaultWidth = 12240) {
    var _a;
    const twips = (_a = props.pageWidth) !== null && _a !== void 0 ? _a : defaultWidth;
 ...
 */
export function getPageHeightPixels(props, defaultHeight = 15840) {
    var _a;
    const twips = (_a = props.pageHeight) !== null && _a !== void 0 ? _a : defaultHeight;
    return Math.round((twips / 1440) * 96);
}
/**
 ...
 */
export function getContentWidthPixels(props) {
    var _a, _b, _c;
    const pageWidth = (_a = props.pageWidth) !== null && _a !== void 0 ? _a : 12240;
    const marginLeft = (_b = props.marginLeft) !== null && _b !== void 0 ? _b : 1440; // 1 inch default
    const marginRight = (_c = props.marginRight) !== null && _c !== void 0 ? _c : 1440;
 ...
 */
export function getContentHeightPixels(props) {
    var _a, _b, _c;
    const pageHeight = (_a = props.pageHeight) !== null && _a !== void 0 ? _a : 15840;
    const marginTop = (_b = props.marginTop) !== null && _b !== void 0 ? _b : 1440;
    const marginBottom = (_c = props.marginBottom) !== null && _c !== void 0 ? _c : 1440;
 ...
 */
export function getMarginsPixels(props) {
    const twipsToPixels = (twips, defaultTwips) => {
        return Math.round(((twips !== null && twips !== void 0 ? twips : defaultTwips) / 1440) * 96);
    };
    return {
 ...
 */
export function hasDifferentFirstPage(props) {
    return props.titlePg === true;
}
/**
 * Check if section has different odd/even page headers/footers
 */
export function hasDifferentOddEven(props) {
    return props.evenAndOddHeaders === true;
}
/**
 * Get effective column count (minimum 1)
 */
export function getColumnCount(props) {
    var _a;
    return Math.max(1, (_a = props.columnCount) !== null && _a !== void 0 ? _a : 1);
}
/**
 * Check if section is landscape
 */
export function isLandscape(props) {
    return props.orientation === 'landscape';
}
/**
 * Check if section has page borders
 */
export function hasPageBorders(props) {
    if (!props.pageBorders)
        return false;
    return !!(props.pageBorders.top ||
 ...
 */
export function mergeSectionProperties(base, override) {
...
//# sourceMappingURL=sectionParser.js.map