 ...
 */
export function getRelationshipTypeName(typeUri) {
 ...
 */
export function isExternalHyperlink(rel) {
 ...
 */
export function isImageRelationship(rel) {
 ...
 */
export function isHeaderRelationship(rel) {
 ...
 */
export function isFooterRelationship(rel) {
 ...
 */
export function getHyperlinks(map) {
 ...
 */
export function getHeaders(map) {
 ...
 */
export function getFooters(map) {
 ...
 */
export function resolveTarget(map, rId) {
    const rel = map.get(rId);
    return rel === null || rel === void 0 ? void 0 : rel.target;
}
/**
 ...
 */
export function resolveRelationship(map, rId) {
    return map.get(rId);
}
/**
 ...
 */
export function resolveRelativePath(basePath, target) {
 ...
 */
export function parseDocumentRelationships(relsXml) {
 ...
 * @returns RelationshipMap
 */
export function parsePackageRelationships(relsXml) {
    return parseRelationships(relsXml);
}
/**
 ...
 */
export function printRelationships(map) {
    /* eslint-disable no-console */
    console.log('Relationships:');
    for (const [id, rel] of map.entries()) {
        const typeName = getRelationshipTypeName(rel.type);
        console.log(`  ${id}: ${typeName} -> ${rel.target}${rel.targetMode === 'External' ? ' (External)' : ''}`);
    }
    /* eslint-enable no-console */
}
//# sourceMappingURL=relsParser.js.map