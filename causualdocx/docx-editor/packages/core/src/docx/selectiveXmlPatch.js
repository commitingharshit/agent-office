 ...
 */
export function findParagraphOffsets(xml, paraId) {
 ...
 */
export function extractParagraphXml(serializedXml, paraId) {
 ...
 */
export function countParagraphElements(xml) {
    let count = 0;
 ...
 */
export function validatePatchSafety(originalXml, serializedXml, changedIds) {
 ...
 */
export function buildPatchedDocumentXml(originalXml, serializedXml, changedIds) {
    if (changedIds.size === 0) {
        return originalXml;
    }
...
//# sourceMappingURL=selectiveXmlPatch.js.map