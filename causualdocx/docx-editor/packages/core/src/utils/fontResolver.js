 ...
 */
export function resolveFontFamily(docxFontName) {
 ...
 */
export function resolveThemeFont(themeRef, fontScheme) {
    var _a, _b, _c, _d, _e;
    if (!fontScheme) {
        return null;
    }
    ...
    if (ref.includes('eastasia') || ref.includes('ea')) {
        return (_b = (_a = themeFont.ea) !== null && _a !== void 0 ? _a : themeFont.latin) !== null && _b !== void 0 ? _b : null;
    }
    if (ref.includes('cs') || ref.includes('bidi')) {
        return (_d = (_c = themeFont.cs) !== null && _c !== void 0 ? _c : themeFont.latin) !== null && _d !== void 0 ? _d : null;
    }
    // Default to Latin/Western font
    return (_e = themeFont.latin) !== null && _e !== void 0 ? _e : null;
}
/**
 ...
 */
export function getGoogleFontsToLoad(docxFonts) {
 ...
 */
export function buildFontFamilyString(fonts, category = 'sans-serif') {
 ...
 */
export function getGoogleFontEquivalent(docxFontName) {
    var _a;
    const normalizedName = docxFontName.trim().toLowerCase();
    const mapping = FONT_MAPPINGS[normalizedName];
    return (_a = mapping === null || mapping === void 0 ? void 0 : mapping.googleFont) !== null && _a !== void 0 ? _a : null;
}
/**
 ...
 */
export function hasGoogleFontEquivalent(docxFontName) {
    const normalizedName = docxFontName.trim().toLowerCase();
    return normalizedName in FONT_MAPPINGS;
}
//# sourceMappingURL=fontResolver.js.map