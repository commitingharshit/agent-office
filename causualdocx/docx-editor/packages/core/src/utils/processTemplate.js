 ...
 */
export function processTemplate(buffer, variables, options = {}) {
 ...
 */
export function processTemplateDetailed(buffer, variables, options = {}) {
 ...
 */
export function processTemplateAsBlob(buffer, variables, options = {}) {
 ...
 * @param options - Processing options
 */
export function processTemplateAndDownload(buffer, variables, filename = 'document', options = {}) {
 ...
 */
export function getTemplateTags(buffer) {
    try {
        const zip = new PizZip(buffer);
        const doc = new Docxtemplater(zip, {
            paragraphLoop: true,
 ...
 */
export function validateTemplate(buffer) {
    const errors = [];
    let tags = [];
    try {
        const zip = new PizZip(buffer);
 ...
 */
export function getMissingVariables(tags, variables) {
    return tags.filter((tag) => !(tag in variables) || variables[tag] === undefined || variables[tag] === null);
}
/**
 ...
 */
export function previewTemplate(buffer, variables) {
    try {
        const zip = new PizZip(buffer);
        const doc = new Docxtemplater(zip, {
            paragraphLoop: true,
...
function formatTemplateError(error) {
    ...
    if (error instanceof Error) {
        ...
        if (isDocxTemplaterError(error) && ((_a = error.properties) === null || _a === void 0 ? void 0 : _a.errors)) {
            // Multi-error from docxtemplater
            const firstError = error.properties.errors[0];
            return {
                message: (firstError === null || firstError === void 0 ? void 0 : firstError.message) || 'Template processing error',
                variable: (_b = firstError === null || firstError === void 0 ? void 0 : firstError.properties) === null || _b === void 0 ? void 0 : _b.tag,
                type: 'render',
                originalError: error,
            };
        }
 ...
 * @returns Processed DOCX as ArrayBuffer
 */
export function processTemplateAdvanced(buffer, data, options = {}) {
 ...
 */
export function createTemplateProcessor(defaultOptions = {}) {
