 ...
 */
export function findWordBoundaries(text, position) {
 ...
 */
export function getWordAt(text, position) {
 ...
 */
export function findWordAt(text, position) {
    const [start, end] = findWordBoundaries(text, position);
    return {
 ...
 */
export function selectWordInTextNode(textNode, offset) {
    const selection = window.getSelection();
    if (!selection)
        return false;
 ...
 */
export function selectParagraphAtCursor() {
    const selection = window.getSelection();
    if (!selection || selection.rangeCount === 0) {
        return false;
    }
 ...
 */
export function handleClickForMultiClick(event) {
 ...
 */
export function createDoubleClickWordSelector() {
    return (event) => {
