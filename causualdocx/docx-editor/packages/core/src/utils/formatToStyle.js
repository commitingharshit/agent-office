...
import { halfPointsToPixels, twipsToPixels, eighthsToPixels, formatPx, halfPointsToPoints, } from './units';
/**
 ...
 */
export function textToStyle(formatting, theme) {
    if (!formatting) {
        return {};
    }
    const style = {};
    ...
    if (formatting.fontFamily) {
        ...
        if (formatting.fontFamily.asciiTheme && (theme === null || theme === void 0 ? void 0 : theme.fontScheme)) {
 ...
 * @returns React CSSProperties
 */
export function paragraphToStyle(formatting, theme) {
    if (!formatting) {
        return {};
    }
    const style = {};
 ...
 */
export function borderToStyle(border, side = '', theme) {
    ...
    style[widthKey] = formatPx(Math.max(1, widthPx));
    style[styleKey] = cssStyle;
 ...
 */
export function resolveShadingFill(shading, theme) {
    if (!shading)
        return '';
 ...
 */
function mapUnderlineStyle(underlineStyle) {
 ...
 */
export function tableCellToStyle(formatting, theme) {
    var _a, _b, _c, _d;
    if (!formatting) {
        return {};
    }
    ...
    if (formatting.margins) {
        if ((_a = formatting.margins.top) === null || _a === void 0 ? void 0 : _a.value) {
            style.paddingTop = formatPx(twipsToPixels(formatting.margins.top.value));
        }
        if ((_b = formatting.margins.bottom) === null || _b === void 0 ? void 0 : _b.value) {
            style.paddingBottom = formatPx(twipsToPixels(formatting.margins.bottom.value));
        }
        if ((_c = formatting.margins.left) === null || _c === void 0 ? void 0 : _c.value) {
            style.paddingLeft = formatPx(twipsToPixels(formatting.margins.left.value));
        }
        if ((_d = formatting.margins.right) === null || _d === void 0 ? void 0 : _d.value) {
 ...
 */
export function sectionToStyle(sectionProps, theme) {
    var _a;
    if (!sectionProps) {
        return {};
    }
    ...
    // Background color
    if ((_a = sectionProps.background) === null || _a === void 0 ? void 0 : _a.color) {
...
//# sourceMappingURL=formatToStyle.js.map