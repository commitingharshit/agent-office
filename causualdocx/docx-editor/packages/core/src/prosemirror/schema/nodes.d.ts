 ...
 */
import type { ParagraphAlignment, ParagraphFormatting, LineSpacingRule, BorderSpec, ShadingProperties, TabStop, TextFormatting, NumberFormat, TableFormatting, TableRowFormatting, TableCellFormatting, SectionProperties } from '../../types/document';
