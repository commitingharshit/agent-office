...
export const FieldExtension = createNodeExtension({
    ...
    nodeSpec: {
        ...
        toDOM(node) {
            const { fieldType, instruction, displayText, fieldKind, fldLock, dirty } = node.attrs;
            ...
            return [
                'span',
                Object.assign(Object.assign(Object.assign({ class: `docx-field docx-field-${fieldType.toLowerCase()}`, 'data-field-type': fieldType, 'data-instruction': instruction, 'data-field-kind': fieldKind }, (fldLock ? { 'data-fld-lock': 'true' } : {})), (dirty ? { 'data-dirty': 'true' } : {})), { style: 'outline: 1px solid rgba(200,200,200,0.4); padding: 0 1px; border-radius: 2px;' }),
                text,
            ];
        },
    },
});
//# sourceMappingURL=FieldExtension.js.map