 ...
 */
function buildSVGGradientDef(gradId, attrs) {
    let stops = '';
    try {
...
export const ShapeExtension = createNodeExtension({
    ...
    nodeSpec: {
        ...
        toDOM(node) {
            ...
            const strokeDash = attrs.outlineStyle === 'dashed'
...
//# sourceMappingURL=ShapeExtension.js.map