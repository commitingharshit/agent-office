...
export const MathExtension = createNodeExtension({
    ...
    nodeSpec: {
        ...
        toDOM(node) {
            const { display, ommlXml, plainText, latex, mathml } = node.attrs;
            const text = plainText || '[equation]';
            return [
                'span',
                Object.assign(Object.assign(Object.assign({ class: `docx-math docx-math-${display}`, 'data-display': display, 'data-omml-xml': ommlXml }, (latex ? { 'data-latex': latex } : {})), (mathml ? { 'data-mathml': mathml } : {})), { style: 'font-style: italic; font-family: "Cambria Math", "Latin Modern Math", serif; ' +
