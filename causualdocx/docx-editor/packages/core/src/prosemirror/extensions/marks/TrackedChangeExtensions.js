...
export const InsertionExtension = createMarkExtension({
    ...
    markSpec: {
        ...
        toDOM(mark) {
            return [
                'span',
                Object.assign(Object.assign({ class: 'docx-insertion', 'data-revision-id': String(mark.attrs.revisionId), 'data-author': mark.attrs.author }, (mark.attrs.date ? { 'data-date': mark.attrs.date } : {})), { style: 'color: #2e7d32;' }),
                0,
            ];
        },
    },
...
export const DeletionExtension = createMarkExtension({
    ...
    markSpec: {
        ...
        toDOM(mark) {
            return [
                'span',
                Object.assign(Object.assign({ class: 'docx-deletion', 'data-revision-id': String(mark.attrs.revisionId), 'data-author': mark.attrs.author }, (mark.attrs.date ? { 'data-date': mark.attrs.date } : {})), { style: 'color: #c62828;' }),
                0,
            ];
        },
    },
});
//# sourceMappingURL=TrackedChangeExtensions.js.map