 ...
 * same reason.
 */
function saveStoredMarksToParagraph(state, tr, marks) {
    ...
    if (paragraph.textContent.length > 0)
        return tr;
    if (marks.length === 0) {
        return tr.setNodeMarkup($from.before(), undefined, Object.assign(Object.assign({}, paragraph.attrs), { defaultTextFormatting: null }));
    }
    const defaultTextFormatting = marksToTextFormatting(marks);
    return tr.setNodeMarkup($from.before(), undefined, Object.assign(Object.assign({}, paragraph.attrs), { defaultTextFormatting }));
}
// ============================================================================
// CORE MARK COMMANDS
// ============================================================================
 ...
 */
function dispatchStoredMarks(state, dispatch, marks) {
    let tr = state.tr;
 ...
 */
function effectiveCursorMarks(state) {
 ...
 */
function boundaryMarks($pos) {
    var _a, _b;
    const before = $pos.nodeBefore;
    const after = $pos.nodeAfter;
    const left = (_a = before === null || before === void 0 ? void 0 : before.marks) !== null && _a !== void 0 ? _a : [];
    const right = (_b = after === null || after === void 0 ? void 0 : after.marks) !== null && _b !== void 0 ? _b : [];
    if (right.length === 0)
        return left;
    if (left.length === 0)
        return right;
 ...
 */
export function isMarkActive(state, markType, attrs) {
    const { from, to, empty } = state.selection;
    if (empty) {
 ...
 */
export function getMarkAttr(state, markType, attr) {
 ...
 */
export function textFormattingToMarks(formatting, schema) {
    const marks = [];
    if (formatting.bold) {
 ...
 */
export function createSetMarkCommand(markType, attrs) {
...
//# sourceMappingURL=markUtils.js.map