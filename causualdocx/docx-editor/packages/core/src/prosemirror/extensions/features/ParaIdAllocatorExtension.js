...
function createParaIdAllocatorPlugin() {
    return new Plugin({
            ...
            newState.doc.descendants((node, pos) => {
                ...
                if (!id || seen.has(id)) {
                    ...
                    while (seen.has(newId))
                        newId = generateHexId();
                    seen.add(newId);
                    updates.push({ pos, attrs: Object.assign(Object.assign({}, node.attrs), { paraId: newId }) });
                }
                else {
                    seen.add(id);
                }
...
//# sourceMappingURL=ParaIdAllocatorExtension.js.map