...
export declare const editorPreferences: EditorPreferences;
export declare function setEditorPreference<K extends keyof EditorPreferences>(key: K, value: EditorPreferences[K]): void;
