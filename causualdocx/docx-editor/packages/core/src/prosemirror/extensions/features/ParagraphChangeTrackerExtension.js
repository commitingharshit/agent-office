...
export const paragraphChangeTrackerKey = new PluginKey('paragraphChangeTracker');
/**
 ...
 */
function collectAffectedParaIdsFromMarkLikeStep(doc, from, to) {
...
function createParagraphChangeTrackerPlugin() {
    return new Plugin({
            ...
            apply(tr, prevState) {
                ...
                for (let stepIndex = 0; stepIndex < tr.steps.length; stepIndex++) {
                    ...
                    if (step instanceof AddMarkStep || step instanceof RemoveMarkStep) {
                        ...
                        const { ids, hasUntracked, blockTypes } = collectAffectedParaIdsFromMarkLikeStep(tr.doc, from, to);
                        for (const id of ids) {
 ...
 */
export function getChangeTrackerState(state) {
    return paragraphChangeTrackerKey.getState(state);
}
/**
 * Get the set of changed paragraph IDs from an EditorState
 */
export function getChangedParagraphIds(state) {
    var _a, _b;
    return (_b = (_a = getChangeTrackerState(state)) === null || _a === void 0 ? void 0 : _a.changedParaIds) !== null && _b !== void 0 ? _b : new Set();
}
/**
 * Check if structural changes (paragraph add/delete) occurred
 */
export function hasStructuralChanges(state) {
    var _a;
    const trackerState = getChangeTrackerState(state);
    return (_a = trackerState === null || trackerState === void 0 ? void 0 : trackerState.structuralChange) !== null && _a !== void 0 ? _a : false;
}
/**
 * Check if any changes affected paragraphs without paraId
 */
export function hasUntrackedChanges(state) {
    var _a;
    const trackerState = getChangeTrackerState(state);
    return (_a = trackerState === null || trackerState === void 0 ? void 0 : trackerState.hasUntrackedChanges) !== null && _a !== void 0 ? _a : false;
}
/**
 ...
 */
export function getChangedBlockTypes(state) {
    var _a, _b;
    return (_b = (_a = getChangeTrackerState(state)) === null || _a === void 0 ? void 0 : _a.changedBlockTypes) !== null && _b !== void 0 ? _b : new Set();
}
/**
 ...
 */
export function hasNonParagraphBlockChanges(state) {
    var _a;
    const trackerState = getChangeTrackerState(state);
    return ((_a = trackerState === null || trackerState === void 0 ? void 0 : trackerState.changedBlockTypes.size) !== null && _a !== void 0 ? _a : 0) > 0;
}
/**
 * Create a transaction that clears the change tracker
 */
export function clearTrackedChanges(state) {
...
//# sourceMappingURL=ParagraphChangeTrackerExtension.js.map