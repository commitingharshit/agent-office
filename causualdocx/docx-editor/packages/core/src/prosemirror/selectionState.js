 ...
 */
function cursorBoundaryMarks(state) {
    var _a, _b, _c, _d;
    if (state.storedMarks)
        return state.storedMarks;
    const $from = state.selection.$from;
    const left = (_b = (_a = $from.nodeBefore) === null || _a === void 0 ? void 0 : _a.marks) !== null && _b !== void 0 ? _b : [];
    const right = (_d = (_c = $from.nodeAfter) === null || _c === void 0 ? void 0 : _c.marks) !== null && _d !== void 0 ? _d : [];
    if (right.length === 0)
        return left;
    if (left.length === 0)
        return right;
 ...
 */
function selectionRangeMarks(state, from, to) {
...
export function extractSelectionState(state) {
    ...
    const paragraphDefaultFormatting = (_a = paragraph.attrs) === null || _a === void 0 ? void 0 : _a.defaultTextFormatting;
    ...
    if (isEmptyParagraph && marks.length === 0 && paragraphDefaultFormatting) {
        textFormatting = Object.assign({}, paragraphDefaultFormatting);
    }
