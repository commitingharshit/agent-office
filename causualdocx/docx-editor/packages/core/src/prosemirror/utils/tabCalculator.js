 ...
 */
export function pixelsToTwips(pixels) {
...
export function computeTabStops(context) {
    const { explicitStops = [], defaultTabInterval = DEFAULT_TAB_INTERVAL_TWIPS, leftIndent = 0, } = context;
 ...
 */
export function calculateTabWidth(currentXPx, context, followingText = '', measureText, decimalSeparator = '.') {
 ...
 */
export function calculateSimpleTabWidth(currentXPx) {
...
//# sourceMappingURL=tabCalculator.js.map