 ...
 */
import type { Document, TextFormatting, ParagraphFormatting } from '../types/document';
import type { Position, Range, AgentContext, StyleInfo } from '../types/agentApi';
import type { AgentCommand } from '../types/agentApi';
import { type SelectiveSaveOptions } from '../docx/selectiveSave';
 ...
 * @returns Promise resolving to DocumentAgent
 */
export declare function createAgent(buffer: ArrayBuffer): Promise<DocumentAgent>;
/**
 ...
 * @returns DocumentAgent
 */
export declare function createAgentFromDocument(document: Document): DocumentAgent;
