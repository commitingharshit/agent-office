...
const fontResolvedCache = new Map();
/**
...
export function buildFontString(style) {
    ...
    const fontSizePt = (_a = style.fontSize) !== null && _a !== void 0 ? _a : DEFAULT_FONT_SIZE;
    const fontSizePx = ptToPx(fontSizePt);
    parts.push(`${fontSizePx}px`);
    // Use the font resolver for category-appropriate fallback stacks
    const fontFamily = (_b = style.fontFamily) !== null && _b !== void 0 ? _b : DEFAULT_FONT_FAMILY;
 ...
 */
export function getFontMetrics(style) {
    var _a, _b;
 ...
 */
export function measureRun(text, style) {
    var _a;
    const metrics = getFontMetrics(style);
    if (!text) {
        return {
    ...
    const ctx = getCanvasContext();
    ctx.font = buildFontString(style);
    const letterSpacing = (_a = style.letterSpacing) !== null && _a !== void 0 ? _a : 0;
    const charWidths = [];
    let totalWidth = 0;
 ...
 */
export function findCharacterAtX(x, charWidths) {
 ...
 */
export function getXForCharacter(offset, charWidths) {
 ...
 */
export function halfPtToPx(halfPt) {
...
//# sourceMappingURL=measureContainer.js.map