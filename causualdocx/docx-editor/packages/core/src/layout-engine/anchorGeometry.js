 ...
 */
export function resolveAnchorX(h, objectWidth, geom) {
    var _a, _b;
    const { pageWidth, marginLeft, contentWidth } = geom;
    const columnX = (_a = geom.columnX) !== null && _a !== void 0 ? _a : 0;
    const columnWidth = (_b = geom.columnWidth) !== null && _b !== void 0 ? _b : contentWidth;
 ...
 */
export function resolveAnchorY(v, objectHeight, fragmentY, geom) {
...
//# sourceMappingURL=anchorGeometry.js.map