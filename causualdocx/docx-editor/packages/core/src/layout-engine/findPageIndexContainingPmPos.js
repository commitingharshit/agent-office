...
export function findPageIndexContainingPmPos(layout, pmPos) {
    ...
    for (let pi = 0; pi < layout.pages.length; pi++) {
        for (const frag of layout.pages[pi].fragments) {
            ...
            const end = (_a = frag.pmEnd) !== null && _a !== void 0 ? _a : start + 1;
...
//# sourceMappingURL=findPageIndexContainingPmPos.js.map