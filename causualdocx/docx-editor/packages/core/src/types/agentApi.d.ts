 ...
 */
export declare function createCollapsedRange(position: Position): Range;
/**
 ...
 */
export declare function comparePositions(a: Position, b: Position): -1 | 0 | 1;
/**
 ...
 * Get action label
 */
export declare function getActionLabel(action: AIAction): string;
/**
 * Get action description
 */
export declare function getActionDescription(action: AIAction): string;
/**
 * Default AI actions for context menu
 */
export declare const DEFAULT_AI_ACTIONS: AIAction[];
/**
 ...
 */
export declare function createCommand<T extends AgentCommand>(command: Omit<T, 'id'>): T;
