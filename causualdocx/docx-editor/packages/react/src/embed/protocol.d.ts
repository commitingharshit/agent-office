 ...
 */
import type { CancelReason, SignatureCompletePayload, SignatureField, SignatureMode, SignedFieldPayload } from '../signing/types';
...
export declare function isCasualEnvelope(value: unknown): value is CasualEnvelope;
