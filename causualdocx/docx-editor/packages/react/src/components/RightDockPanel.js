...
export function RightDockPanel({ title, icon, headerActions, onClose, children, footer, testId, ariaLabel, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("aside", { role: "complementary", "aria-label": ariaLabel !== null && ariaLabel !== void 0 ? ariaLabel : (typeof title === 'string' ? title : 'Side panel'), "data-testid": testId, style: ROOT_STYLE, children: [_jsxs("div", { style: HEADER_STYLE, children: [icon && (_jsx("span", { style: HEADER_ICON_STYLE, "aria-hidden": "true", children: icon })), _jsx("span", { style: TITLE_STYLE, children: title }), headerActions, _jsx("button", { type: "button", style: closeBtnStyle(closeHover), onClick: onClose, onMouseEnter: () => setCloseHover(true), onMouseLeave: () => setCloseHover(false), onFocus: () => setCloseHover(true), onBlur: () => setCloseHover(false), "aria-label": "Close panel", "data-testid": testId ? `${testId}-close` : undefined, children: _jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [_jsx("path", { d: "M18 6L6 18" }), _jsx("path", { d: "M6 6l12 12" })] }) })] }), _jsx("div", { style: BODY_STYLE, children: children }), footer && _jsx("div", { style: FOOTER_STYLE, children: footer })] })] }));
}
export default RightDockPanel;
//# sourceMappingURL=RightDockPanel.js.map