...
export function UnifiedSidebar({ items, anchorPositions, renderedDomContext, pageWidth, zoom, editorContainerRef, onExpandedItemChange, activeItemId, }) {
    const { t } = useTranslation();
    // Fully controlled: parent owns expansion state via activeItemId
    const expandedItem = activeItemId !== null && activeItemId !== void 0 ? activeItemId : null;
    ...
    const cardHeightsRef = useRef(new Map());
    ...
    const measureRefsRef = useRef(new Map());
    const [positionVersion, setPositionVersion] = useState(0);
    const resolved = useMemo(() => resolveItemPositions(items, anchorPositions, renderedDomContext, zoom, cardHeightsRef.current, lastKnownRef.current), 
    ...
    useEffect(() => {
        const container = editorContainerRef === null || editorContainerRef === void 0 ? void 0 : editorContainerRef.current;
        if (!container)
            return;
    ...
    const getMeasureRef = useCallback((itemId) => {
    ...
    const toggleExpand = useCallback((itemId) => {
        onExpandedItemChange === null || onExpandedItemChange === void 0 ? void 0 : onExpandedItemChange(expandedItemRef.current === itemId ? null : itemId);
    }, [onExpandedItemChange]);
    if (items.length === 0)
        return null;
    return (_jsx("aside", { ref: sidebarRef, className: "docx-unified-sidebar", role: "complementary", "aria-label": t('sidebar.ariaLabel'), style: {
            position: 'absolute',
            top: 0,
        ...
        }, onMouseDown: (e) => e.stopPropagation(), children: _jsx("div", { style: { position: 'relative' }, children: items.map((item) => {
                ...
                const transition = noPosition
                    ...
                    : isNewCard || item.isTemporary
                        ...
                        : initialPositionsDone
                            ...
                            : 'none';
                return (_jsx("div", { style: Object.assign(Object.assign({}, style), { transition }), children: item.render({
                        isExpanded,
...
//# sourceMappingURL=UnifiedSidebar.js.map