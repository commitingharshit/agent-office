...
const pillStyle = (visible) => ({
    ...
    boxShadow: '0 1px 1px rgba(0, 0, 0, 0.04), 0 6px 16px rgba(0, 0, 0, 0.16), 0 24px 64px rgba(15, 23, 42, 0.22)',
    opacity: visible ? 1 : 0,
...
export function FocusModeBar({ wordCount, isActive }) {
    ...
    if (!isActive)
        return null;
    return (_jsx("div", { style: wrapStyle, "aria-hidden": !visible, children: _jsxs("div", { style: pillStyle(visible), "data-testid": "focus-mode-bar", children: [_jsxs("span", { children: [wordCount.toLocaleString(), " ", wordCount === 1 ? 'word' : 'words'] }), _jsx("span", { style: dotStyle, children: "\u00B7" }), _jsx("span", { children: formatReadTime(wordCount) }), _jsx("span", { style: dotStyle, children: "\u00B7" }), _jsxs("span", { children: [_jsx("kbd", { style: escKbdStyle, children: "Esc" }), "to exit"] })] }) }));
}
export default FocusModeBar;
//# sourceMappingURL=FocusModeBar.js.map