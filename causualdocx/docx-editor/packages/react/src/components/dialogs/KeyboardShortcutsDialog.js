...
const ShortcutItem = ({ shortcut, translatedName, translatedDescription, }) => {
    ...
    return (_jsxs("div", { className: "docx-shortcut-item", style: {
            ...
            borderBottom: '1px solid var(--doc-border-light)',
                            ...
                            fontWeight: 500,
                            color: 'var(--doc-text)',
                        }, children: translatedName }), _jsx("div", { style: {
                            fontSize: '11px',
                            color: 'var(--doc-text-muted)',
                            marginTop: '2px',
                        }, children: translatedDescription })] }), _jsxs("div", { style: {
                    display: 'flex',
                    gap: '8px',
                    alignItems: 'center',
                            ...
                            boxShadow: '0 1px 1px rgba(0,0,0,0.1)',
                        }, children: formattedKeys }), formattedAltKeys && (_jsxs(_Fragment, { children: [_jsx("span", { style: { color: 'var(--doc-text-subtle)', fontSize: '11px' }, children: "or" }), _jsx("kbd", { style: {
                                    display: 'inline-flex',
                                    alignItems: 'center',
                                    padding: '4px 8px',
                                    fontSize: '12px',
                                    ...
                                    border: '1px solid var(--doc-border-light)',
                                    boxShadow: '0 1px 1px rgba(0,0,0,0.1)',
                                }, children: formattedAltKeys })] }))] })] }));
};
// ============================================================================
// KEYBOARD SHORTCUTS DIALOG COMPONENT
// ============================================================================
export const KeyboardShortcutsDialog = ({ isOpen, onClose, customShortcuts = [], showSearch = true, className = '', }) => {
    ...
    useEffect(() => {
        if (isOpen && showSearch && searchInputRef.current) {
            setTimeout(() => { var _a; return (_a = searchInputRef.current) === null || _a === void 0 ? void 0 : _a.focus(); }, 0);
        }
    }, [isOpen, showSearch]);
    ...
    if (!isOpen)
        return null;
    return (_jsx(FocusTrap, { children: _jsx("div", { className: "docx-shortcuts-overlay", style: {
                position: 'fixed',
                top: 0,
                left: 0,
                right: 0,
                ...
                zIndex: 10001,
            }, children: _jsxs("div", { ref: dialogRef, className: `docx-shortcuts-dialog ${className}`, style: {
                    width: '600px',
                    maxWidth: '90vw',
                    maxHeight: '80vh',
                    ...
                    overflow: 'hidden',
                }, role: "dialog", "aria-modal": "true", "aria-label": t('dialogs.keyboardShortcuts.ariaLabel'), children: [_jsxs("div", { style: {
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'space-between',
                            padding: '16px 20px',
                            borderBottom: '1px solid var(--doc-border)',
                                    ...
                                    fontWeight: 600,
                                    color: 'var(--doc-text)',
                                }, children: t('dialogs.keyboardShortcuts.ariaLabel') }), _jsx("button", { type: "button", onClick: onClose, "aria-label": t('common.closeDialog'), style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    width: '32px',
                                    ...
                                    borderRadius: '50%',
                                    color: 'var(--doc-text-muted)',
                                }, children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: _jsx("path", { d: "M5 5l10 10M15 5L5 15", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) }) })] }), showSearch && (_jsx("div", { style: { padding: '12px 20px', borderBottom: '1px solid var(--doc-border)' }, children: _jsx("input", { ref: searchInputRef, type: "text", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: t('dialogs.keyboardShortcuts.searchPlaceholder'), style: {
                                width: '100%',
                                padding: '10px 12px',
                                fontSize: '14px',
                                border: '1px solid var(--doc-border-light)',
                            ...
                            overflowY: 'auto',
                            padding: '16px 20px',
                        }, children: groupedShortcuts.length === 0 ? (_jsx("div", { style: {
                                textAlign: 'center',
                                padding: '32px',
                                color: 'var(--doc-text-muted)',
                            }, children: t('dialogs.keyboardShortcuts.noResults', { query: searchQuery }) })) : (groupedShortcuts.map(({ category, shortcuts }) => (_jsxs("div", { style: { marginBottom: '24px' }, children: [_jsx("h3", { style: {
                                        margin: '0 0 12px 0',
                                        fontSize: '13px',
                                        fontWeight: 600,
                                        ...
                                        letterSpacing: '0.5px',
                                    }, children: t(CATEGORY_LABEL_KEYS[category]) }), _jsx("div", { children: shortcuts.map((shortcut) => (_jsx(ShortcutItem, { shortcut: shortcut, translatedName: shortcut.nameKey ? t(shortcut.nameKey) : shortcut.name, translatedDescription: shortcut.descriptionKey
                                            ? t(shortcut.descriptionKey)
                                            : shortcut.description }, shortcut.id))) })] }, category)))) }), _jsx("div", { style: {
                            padding: '12px 20px',
                            ...
                            return (_jsxs(_Fragment, { children: [parts[0], _jsx("kbd", { style: {
                                            padding: '2px 6px',
                                            backgroundColor: 'var(--doc-surface, white)',
                                            borderRadius: '4px',
                                            border: '1px solid var(--doc-border-light)',
                                        }, children: "Esc" }), parts[1]] }));
                        })() })] }) }) }));
};
// ============================================================================
 ...
 */
export function useKeyboardShortcutsDialog(options = {}) {
