 ...
 */
export function findVerticalScrollParentOrRoot(el) {
    var _a;
    return (_a = findVerticalScrollParent(el)) !== null && _a !== void 0 ? _a : document.documentElement;
}
//# sourceMappingURL=findVerticalScrollParent.js.map