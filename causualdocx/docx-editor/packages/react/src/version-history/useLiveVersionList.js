...
import { listVersions, setLiveFeed } from './store';
import { createLiveVersionFeed } from './live-feed';
import { fetchServerVersions } from './server-source';
/**
...
export function getLiveVersionFeed() {
    if (!liveFeed) {
...
export function useLiveVersionList(docId, serverBackend) {
    var _a, _b;
    const [list, setList] = useState([]);
    const serverBase = (_a = serverBackend === null || serverBackend === void 0 ? void 0 : serverBackend.baseUrl) !== null && _a !== void 0 ? _a : null;
    const serverDoc = (_b = serverBackend === null || serverBackend === void 0 ? void 0 : serverBackend.docId) !== null && _b !== void 0 ? _b : null;
    useEffect(() => {
        if (!docId) {
            setList([]);
            return;
...
//# sourceMappingURL=useLiveVersionList.js.map