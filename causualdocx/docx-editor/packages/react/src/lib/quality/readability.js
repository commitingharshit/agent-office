...
function countWords(text) {
    var _a;
    return (_a = text.match(WORD_RE)) !== null && _a !== void 0 ? _a : [];
}
function countSentences(text) {
    ...
    if (!stripped)
        return 0;
    const base = (_a = matches === null || matches === void 0 ? void 0 : matches.length) !== null && _a !== void 0 ? _a : 0;
...
export function syllableCount(word) {
    ...
    return Math.max(1, (_a = groups === null || groups === void 0 ? void 0 : groups.length) !== null && _a !== void 0 ? _a : 1);
}
/**
...
export function computeReadability(text) {
    ...
    const longSentences = (() => {
        ...
        for (const p of parts) {
            ...
            if (w.length > LONG_SENTENCE_WORDS)
                count += 1;
        }
        return count;
    })();
 ...
 */
export function formatReadingTime(ms) {
...
export function gradeLabel(grade) {
    ...
    if (grade <= 6)
        return `Grade ${grade} · plain`;
    if (grade <= 9)
        return `Grade ${grade} · everyday`;
    if (grade <= 12)
        return `Grade ${grade} · scholarly`;
