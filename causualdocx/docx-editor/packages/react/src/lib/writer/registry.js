...
export const FEATURES = [
    ...
    },
    {
        ...
        description: 'Higher-quality rewrites and summaries from an on-device LLM. Replaces the basic model when active. Needs WebGPU and ~4 GB device memory.',
 ...
 * in the UI tooltip.
 */
export function isFeatureSupported(feature, caps) {
