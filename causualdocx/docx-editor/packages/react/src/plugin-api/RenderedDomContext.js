 ...
 * to span elements.
 */
export class RenderedDomContextImpl {
    ...
    getRectsForRange(from, to) {
        ...
        for (const spanEl of spans) {
            ...
            if (pmEnd > from && pmStart < to) {
                ...
                if (((_a = spanEl.firstChild) === null || _a === void 0 ? void 0 : _a.nodeType) !== Node.TEXT_NODE)
                    continue;
                const textNode = spanEl.firstChild;
                const ownerDoc = spanEl.ownerDocument;
                if (!ownerDoc)
 ...
 */
export function createRenderedDomContext(pagesContainer, zoom = 1) {
    return new RenderedDomContextImpl(pagesContainer, zoom);
}
//# sourceMappingURL=RenderedDomContext.js.map