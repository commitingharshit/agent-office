...
export type { EditorPluginCore, PluginPanelProps, PanelConfig, RenderedDomContext, PositionCoordinates, SidebarItem, SidebarItemContext, } from '@eigenpal/docx-core/plugin-api';
import type { EditorPluginCore, PluginPanelProps, RenderedDomContext, SidebarItem, SidebarItemContext } from '@eigenpal/docx-core/plugin-api';
/**
